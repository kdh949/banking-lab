...
class LedgerController(
    ...
    fun closeBusinessDay(@RequestBody command: DailyClosingCommand): ResponseEntity<DailyClosingResult> {
        val result = ledgerCommandService.closeBusinessDay(command)
