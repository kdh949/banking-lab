...
class PaymentSecurityConfig(
    ...
    @Bean
    fun paymentSecurityFilterChain(
        http: HttpSecurity,
        entryPoint: PaymentAuthenticationEntryPoint,
        jwtAuthenticationConverter: PaymentJwtAuthenticationConverter
    ): SecurityFilterChain {
        ...
        http.authorizeHttpRequests {
            ...
            it.requestMatchers("/api/payments/**").authenticated()
    ...
    fun paymentJwtDecoder(
        ...
        PaymentResourceServerJwtDecoder(
            objectMapper,
            jwksUri,
            expectedIssuer,
            expectedAudience,
