...
@ConfigurationProperties(prefix = "banking-lab.reporting-service.domain-event-publisher")
data class ReportingDomainEventPublisherProperties(
    ...
    fun publisherConfig(): ReportingKafkaPublisherConfig =
