export const staffWorkflowRouteSummaries = [
  ...
  { href: "/customers/[customerId]", title: "Customer Lookup", screenIds: ["CST-001", "CST-002", "CST-003", "CST-104", "CST-201", "CST-202"] },
  { href: "/accounts/[accountId]", title: "Account Operations", screenIds: ["ACC-101", "ACC-102", "ACC-103", "ACC-104", "ACC-201", "ACC-202", "LIM-101", "LIM-102", "FEE-102"] },
