...
| Reconciliation adjustment as ledger transaction | `LedgerCore.adjustment`, `ReconciliationOpsService`, `LedgerCommandService.adjustment` | Phase 6 tests, reconciliation API integration test |
