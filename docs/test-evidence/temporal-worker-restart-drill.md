...
This closes the live Temporal SDK worker restart drill for the current synthetic workflow contract. Node retirement remains blocked until host crash shapes, outbox tracing, non-synthetic passkey operations, evidence-refresh completion, and final retirement review are complete.
