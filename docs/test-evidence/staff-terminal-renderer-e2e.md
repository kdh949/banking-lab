...
Latest local result after the 2026-06-05 operational retry queue update:

- `npm run test:e2e -- apps/staff-terminal/e2e/staff-terminal-parity.spec.ts`
- 5 passed
- 16 skipped because `BANKING_LAB_E2E_API_BASE_URL`, payment API, and Keycloak E2E environment variables were not configured
