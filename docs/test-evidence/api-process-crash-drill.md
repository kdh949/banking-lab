...
This closes the API process crash after durable ledger/outbox commit blocker for the current synthetic customer-transfer path. Node retirement remains blocked until non-synthetic passkey operations, evidence-refresh completion, and final retirement review are complete.
