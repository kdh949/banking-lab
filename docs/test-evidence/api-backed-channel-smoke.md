...
- The synthetic seed now includes dedicated transfer-limit, KYC, and fee waiver command rows so the `LIM102`, `KYC101`, and `FEE102` browser smokes do not mutate existing account/customer read-model assertions.
