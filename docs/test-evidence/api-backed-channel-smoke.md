...
- Node retirement remains blocked by host crash shapes, outbox tracing, non-synthetic passkey operations, evidence-refresh completion, and final retirement review.
