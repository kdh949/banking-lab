...
- Node service-shaped oracle helpers have been moved under `legacy-node-reference/services`; target `services/` now has a structural guard against `.mjs` business modules while the reference runtime remains preserved.
