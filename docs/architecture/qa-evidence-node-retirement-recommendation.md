...
| `evidence-refresh` | In progress | Keep in progress until full target command outputs, host crash shapes, API process crash after durable ledger/outbox commit, deployed post-broker-ack outbox worker crash, and outbox tracing are captured. |
