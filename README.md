...
- extend springdoc/Jackson DTO schema generation beyond payment-service, notification-service, and reporting-service, and broaden live broker-backed event-envelope coverage beyond the current contract gates
