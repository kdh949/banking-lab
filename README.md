...
- extend springdoc/Jackson DTO schema generation beyond the core-banking ledger command and inquiry subsets plus payment-service, notification-service, and reporting-service, and broaden live broker-backed event-envelope coverage beyond the current contract gates
